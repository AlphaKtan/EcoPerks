    ...
    <div class="left-menu">
        <div>
            <ul class="menu-list">
                ...
                <li class="menu-item"><a href="time_change.php" class="a_link"><img src="../img/qr.png" class="logo"><span class="menu-item-text">シフト削除</span></a></li>
                <li class="menu-item"><a href="access_log.php" class="a_link"><img src="../img/qr.png" class="logo"><span class="menu-item-text">アクセスログ表示ページ</span></a></li>
            </ul>
        </div>
        <div>
